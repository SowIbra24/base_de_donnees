/* sql pour peupler la region à executer separemment*/

INSERT INTO `Region`(`Code_INSEE_R`, `NOM_R`)

SELECT DISTINCT code_region, nom_region 
FROM dataset.Communes 
WHERE nom_region LIKE "Auvergne-Rhône-Alpes"; 

 /* pour peupler les departements à executer separemet aussi  */
...
/* peuupler les communes à executer separement */
...
INSERT INTO `Citoyen`(`emailC`, `NomC`, `PrenomC`, `Date_naissC`, `num_telC`) VALUES ("fabien.favettao@gmail.com","Favetta","Fabien",'2003-04-30',"0970797625");
INSERT INTO `Citoyen`(`emailC`, `NomC`, `PrenomC`, `Date_naissC`, `num_telC`) VALUES ("frank.duchateau","DUchateau","Frank",'2003-01-18',"0795756314");
